...
class SailorStoreTest extends StoreTestCase
{
    ...
    public function testItShouldCountCreatedBetweenDates(): void
    {
        ...
        $store->store(SailorAggregateBuilder::new()->wasCreated(createDate: $lockedCLock->now())->build());
    ...
    public function testItShouldCountDeletedBetweenDates(): void
    {
        ...
        $store->store(SailorAggregateBuilder::new()->wasCreated(createDate: $lockedCLock->now())->wasDeleted()->build());
