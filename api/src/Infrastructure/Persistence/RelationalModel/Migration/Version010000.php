...
final class Version010000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE bottle (id VARCHAR(36) NOT NULL, receiver_id VARCHAR(36) DEFAULT NULL, message VARCHAR(500) NOT NULL, create_ip VARCHAR(45) NOT NULL, create_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, receive_date TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE sailor (id VARCHAR(36) NOT NULL, email VARCHAR(50) NOT NULL, create_ip VARCHAR(45) NOT NULL, create_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
